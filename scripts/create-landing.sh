...
echo "[next] ajuste config/content/${CONTENT_FILE}.php e imagens, rode composer install e valide com php scripts/validate-landing-content.php --content ${CONTENT_FILE}"
